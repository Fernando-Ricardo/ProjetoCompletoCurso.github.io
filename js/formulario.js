...
function formularioEnviado(resposta) {
    if(resposta.ok){
        formulario.innerHTML = '<p class="font-2-l" style="grid-column:1/-1; padding: 1rem; border-radius: 4px; background: #f7f7f7;"><span style="color:#317A00">"Mensagem enviada</span>, em breve entraremos em conatato. Geralmente respondemos em 25horas.</p>'
    }else {
